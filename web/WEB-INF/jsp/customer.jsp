...
<div id="wrapper">
	...
	<div id="page-wrapper">
		...
		<div>
			<a href="#" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#customerAddDialog" onclick="insertCustomer()">添加</a>
		</div>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myAddModalLabel">添加客户信息</h4>
			</div>
			<div class="modal-body">
...
<script type="text/javascript">
	...
	function editCustomer(id) {
		$.ajax({
			type:"get",
			url:"${pageContext.request.contextPath }/customer/detail",
			data:{"id":id},
	...
	function addCustomer() {
		$.post("${pageContext.request.contextPath }/customer/add",$("#add_customer_form").serialize(),function(data){
			alert("客户信息添加成功！");
			window.location.reload();
		});
	}
